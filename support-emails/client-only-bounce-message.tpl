            ...
            <table class="twelve columns">
                ...
                <tr>
                    <td>
                        ...
                        <p class="lead">The email you used is not associated with your <a
                                    title="StrikeHawk Billing System"
                                    href="https://services.strikehawk.com/clientportal.php">StrikeHawk eCommerce
                                Portal</a>.</p>
                    </td>
            ...
            <table class="twelve columns">
                ...
                <tr>
                    <td class="panel">
                        ...
                        <p><strong>Your email to our support system could not be accepted because it was not recognized
                                ...
                                information or message us on social media.</strong></p>
                    </td>
                    <td class="expander"> </td>
                </tr>
                </tbody>
