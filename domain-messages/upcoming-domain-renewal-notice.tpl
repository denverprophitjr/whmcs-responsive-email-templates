            ...
            <table class = "twelve columns"
                ...
                <tr style = "padding: 0;vertical-align:top;text-align:left;">
                    <td class = "panel"
                        ...
                        <p>To ensure the domain does not expire, you should renew it now. You can do this from the <a
                                    href = "{$whmcs_url}/clientarea.php?action=domains" title = "My Domains">domains
                                                                                                             management
                                                                                                             section</a>
                           of our online billing portal. </p>

                        <p>
                            Should you allow the domain to expire, you will be able to renew it for up to 30 days after
                            the renewal date. During this time, the domain will not be accessible so any web site or
                            email services associated with it will stop working. </p>
                    </td>
                </tr>
                </tbody>
            </table>
