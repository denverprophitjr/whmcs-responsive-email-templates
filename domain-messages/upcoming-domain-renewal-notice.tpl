            ...
            <table class = "twelve columns"
                ...
                <tr style = "padding: 0;vertical-align:top;text-align:left;">
                    <td style="word-break: keep-all;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse !important;vertical-align:top;color:#222222;font-family:'Helvetica', 'Arial', sans-serif;font-weight:normal;margin: 0;text-align:left;font-size:14px;line-height:19px;padding: 0 0 10px;">
                        ...
                        <p class = "lead"
                           style="word-break: keep-all;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;color:#222222;font-family:'Helvetica', 'Arial', sans-serif;font-weight:normal;padding: 0;text-align:left;margin: 0 0 10px;font-size:18px;line-height:21px;">
                            It is time to renew {$domain_name}.</p>
            ...
            <table class = "twelve columns"
                ...
                <tr style = "padding: 0;vertical-align:top;text-align:left;">
                    <td class = "panel"
                        ...
                        <p>
                            To ensure the domain does not expire, you should renew it now. You can do this from the <a
                                    href="{$whmcs_url}/clientarea.php?action=domains" title="My Domains">domains
                                management section</a> of our online billing portal.
                        </p>

                        <p style="word-break: keep-all;-webkit-hyphens:auto;-moz-hyphens:auto;hyphens:auto;border-collapse:collapse !important;vertical-align:top;color:#222222;font-family:'Helvetica', 'Arial', sans-serif;font-weight:normal;margin: 0;text-align:left;font-size:14px;line-height:19px;padding: 10px !important;background: #ECF8FF none repeat scroll top left;border: 1px solid #b9e5ff;">
                            Should you not allow the domain to expire. You will be able to renew it for up to 30 days
                            after
                            the renewal date. During this time, the domain <strong>will not</strong> be accessible. So,
                            any web site or
                            email services associated with it will stop working.
                        </p>
                    </td>
                </tr>
                </tbody>
